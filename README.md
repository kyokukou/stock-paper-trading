...
The responsive webapp was made in Angular with pieces from material UI and used the same Node.js backend.
The webpage was created using html, css and javascript and used a python backend.

Demo video/screenshots provided, but files are unavailable to be posted publically due to USC's academic integrity policy. Please inquire to discuss the project further.
